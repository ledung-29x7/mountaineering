...
import '../../css/dt.css';
import img1 from '../../../img/location/himalayan_9/1.avif'
import img2 from '../../../img/location/himalayan_9/2.jpeg'
import img3 from '../../../img/location/himalayan_9/3.avif'
import img4 from '../../../img/location/himalayan_9/4.avif'
import img5 from '../../../img/location/himalayan_9/5.avif'
import img6 from '../../../img/location/himalayan_9/6.avif'
...
const Himalayan =()=>{
    return(
        <div className="test">
            <h1>9 Himalayan peaks that are perfect for beginners to mountaineering</h1>
            <p>
            ...
            <p>
                Need to know: Probably one of the easiest 6,000+ meter peaks in the Himalayas. It has a huge dome-shaped peak which gets a lot of high-speed wind because of exposure. However, the climb doesn’t pose much technical difficulties. Acclimatization is necessary for this peak. From base to summit is roughly a 7.8-km trek with a 1,150-meter elevation gain in total.</p>
            <p>
