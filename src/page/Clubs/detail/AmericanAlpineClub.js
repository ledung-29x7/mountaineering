import img1 from "../../../img/clubs/American Alpine Club/1.png";
...
function AAC(){
    return (
        <div className="test">
            ...
            <div className="logoClubs"><img className="logoACC" src={img1}></img>
            </div>
            ...
            <div className="block"><img src={img3}></img>
            ...
            <div className="block"><img src={img4}></img>
