...
const Dynamic_Climbing =()=>{
    return(
        <div className="test">
            ...
            <ReactPlayer url='https://youtu.be/x6g-RuorVh8' width="100%" playing={false} controls={true}></ReactPlayer>
            <h2>Figure 2. Arm-jump board test</h2>
            <ReactPlayer url='https://youtu.be/ktQOSsizjC8' width="100%" playing={false} controls={true}></ReactPlayer>
           ...
           <ReactPlayer url='https://youtu.be/LR_xgR7Ygig' width="100%" playing={false} controls={true}></ReactPlayer>
           <h2>Training</h2>
           ...
           <ReactPlayer url='https://youtu.be/SY7rksuY6bg' width="100%" playing={false} controls={true}></ReactPlayer>
            <h3>Figure 5. Plyometric pull-ups with a band</h3>
            <ReactPlayer url='https://youtu.be/A-KMRTE5SVk' width="100%" playing={false} controls={true}></ReactPlayer>
            <h3>Figure 6. Bumps on campus board</h3>
            <ReactPlayer url='https://youtu.be/fMjpbpD9HzE' width="100%" playing={false} controls={true}></ReactPlayer>
            ...
            <ReactPlayer url='https://youtu.be/EvIn7w3AQfY' width="100%" playing={false} controls={true}></ReactPlayer>
            <h3>Figure 8. Depth jump</h3>
            <ReactPlayer url='https://youtu.be/AQCSLCBHrCk' width="100%" playing={false} controls={true}></ReactPlayer>
            ...
            <ReactPlayer url='https://youtu.be/_CGVo6YtVvQ' width="100%" playing={false} controls={true}></ReactPlayer>
            <h3>Figure 10. Explosive hamstring exercise on bosu</h3>
            <ReactPlayer url='https://youtu.be/gZbNQEjtfXk' width="100%" playing={false} controls={true}></ReactPlayer>
